...
static const yytype_uint8 yyrline[] =
{
     ...
     129,   131,   132,   135,   138,   139,   142,   143,   146,   147,
     150,   151,   152,   153,   154,   157,   160,   161,   164,   167,
     168,   171,   172,   175,   176,   177,   178,   179,   180,   181,
     182,   183,   184,   185,   186,   187,   188,   189,   190,   191,
     192,   193,   194,   197,   198,   201,   202,   205,   206
};
#endif
...
/* Line 1792 of yacc.c  */
#line 106 "parser.y"
    {(yyval.declaration_ptr)=new DeclarationNode((yyvsp[(1) - (2)].type_ptr),new std::list<IdentifierNode*>(1,(yyvsp[(2) - (2)].identifier_ptr)));}
    break;
...
/* Line 1792 of yacc.c  */
#line 129 "parser.y"
    {(yyval.parameter_ptr)=new ParameterNode((yyvsp[(1) - (2)].type_ptr),(yyvsp[(2) - (2)].identifier_ptr));}
    break;
...
/* Line 1792 of yacc.c  */
#line 142 "parser.y"
    {(yyval.identifier_list_ptr)=(yyvsp[(1) - (3)].identifier_list_ptr); (yyval.identifier_list_ptr)->push_back((yyvsp[(3) - (3)].identifier_ptr));}
    break;
...
/* Line 1792 of yacc.c  */
#line 167 "parser.y"
    {(yyval.statement_list_ptr)->push_back((yyvsp[(2) - (2)].statement_ptr));}
    break;
...
/* Line 1792 of yacc.c  */
#line 191 "parser.y"
    {(yyval.expression_ptr)=new BooleanLiteralNode((yyvsp[(1) - (1)].integer_ptr));}
    break;
